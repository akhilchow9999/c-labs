...
namespace GreatOutdoors.DataAccesslayer
{
    ...
    public class OrderDetails
    {
        ...
        //  public static Dictionary<int, List<int>> orders = new Dictionary<int, List<int>>();//order id with products
        ...
        public void GetAllOrders()
        {
            ...
            {            
                ...
                {
                    Console.WriteLine(i + "\t" + p.ProductOrderedQuantity.ToString());
                }
            }
        }
        ...
        {
            //updates dictionary of order id and date of order
